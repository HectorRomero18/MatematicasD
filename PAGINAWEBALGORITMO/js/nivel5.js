...
function mostrarAlerta() {
  ...
  if (result.isConfirmed) {
    ...
    window.location.href = '/MatematicasD/PAGINAWEBALGORITMO/pages/animales7.html';
  }      
      });
...
function mostrarAlertaIncorrecta() {
  ...
  footer: '<a href="/pages/Clases.html" class="enlace-ayuda">Necesitas Ayuda?</a>',
  background:'#444444',
  });
}
